...
$ProhibitedUids = @(
    ...
    "Integrations_Source",
    # Every card below lives inside the Link Tooltip page's nested rule editor,
    # which only exists once a rule is open. A search result cannot navigate
    # there, so indexing them would strand the user on the rules list.
    "LinkTooltip_OverrideHideDelay",
    "LinkTooltip_OverrideMaxWidth",
    "LinkTooltip_OverrideShowDelay",
    "LinkTooltip_RuleButtons",
    "LinkTooltip_RuleCustomExtensions",
    "LinkTooltip_RuleEnabled",
    "LinkTooltip_RuleFileTypeGroup",
    "LinkTooltip_RuleIntegration",
    "LinkTooltip_RuleKind",
    ...
    "LinkTooltip_RuleSchemes",
    "LinkTooltip_RuleShowInPane",
    "LinkTooltip_RuleShowPreview",
